...
public:       
  ...
  void Run(void)
  {    
    static typename PulseIn::queue_t::QueueSize_t data;
    ...
    if(PulseIn::Q.Available())
    {
      ...
      {       
        ...
        else if( (data > HDR_SPACE - ONE_MARK_TOLERANCE) &&  (data < HDR_SPACE + ONE_MARK_TOLERANCE) ) // Header found
        {          
          Result = 0;
          Mask = (1UL << (IR_BITS-1));
          State = HEADER_FOUND;
