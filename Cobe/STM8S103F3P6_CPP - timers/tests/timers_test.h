...
pulseIn1<Timer1_Channel_2,15,0xffff> PulseIn1;
pulseIn2<Timer2_Channel_1,4,0xffff> PulseIn2;
void pulseIn_test(void)
{
  PulseIn2.HwInit();
  PulseIn2.Start();
...
pulseOut1<Timer1_Channel_1 ,1000> IrOut;
//pulseOut2<Timer2_Channel_1 ,1000> IrOut;
void pulseOut_test(void)
{  
  uint8_t duty = 50;
  IrOut.HwInit();
