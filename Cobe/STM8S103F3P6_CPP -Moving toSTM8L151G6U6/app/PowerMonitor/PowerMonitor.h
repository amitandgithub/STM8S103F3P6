...
namespace App
{
  typedef enum
  {
    ...
    template<typename CurrentSensor_t, typename ssd1306_t>
    class PowerMonitor
    {
      public:
      ...
      static void Init(void)
      {
        ...
        //CurrentSensor_t::SetCalibration_16V_400mA(); //SetCalibration_16V_400mA  SetCalibration_32V_2A
        Button.HwInit();
        UpdateMode();
      }
      ...
      static void UpdateClock(void)
      {
        if(Mode == 0)
        {
          CountertoTime(Seconds,DispBuf);
          ssd1306_t::Puts(DispBuf,5,ssd1306_t::c1,ssd1306_t::l1);
        }
      }
    ...
    template<typename CurrentSensor_t, typename ssd1306_t>
      char PowerMonitor<CurrentSensor_t,ssd1306_t>::DispBuf[11];
    
    template<typename CurrentSensor_t, typename ssd1306_t>
      volatile uint8_t PowerMonitor<CurrentSensor_t,ssd1306_t>::RunLoop = 1;
    
    template<typename CurrentSensor_t, typename ssd1306_t>
      PowerMonitor<CurrentSensor_t,ssd1306_t>::Power_t PowerMonitor<CurrentSensor_t,ssd1306_t>::Power;
    
    template<typename CurrentSensor_t, typename ssd1306_t>
      uint16_t PowerMonitor<CurrentSensor_t,ssd1306_t>::Seconds;
    
    template<typename CurrentSensor_t, typename ssd1306_t>
      float PowerMonitor<CurrentSensor_t,ssd1306_t>::CurrentSamples;
    
    template<typename CurrentSensor_t, typename ssd1306_t>
      uint8_t PowerMonitor<CurrentSensor_t,ssd1306_t>::SampleCount; 
    
    template<typename CurrentSensor_t, typename ssd1306_t>
      uint8_t PowerMonitor<CurrentSensor_t,ssd1306_t>::Mode = 1;
    
    template<typename CurrentSensor_t, typename ssd1306_t>
      PowerMonitor<CurrentSensor_t,ssd1306_t>::Button_t PowerMonitor<CurrentSensor_t,ssd1306_t>::Button;
