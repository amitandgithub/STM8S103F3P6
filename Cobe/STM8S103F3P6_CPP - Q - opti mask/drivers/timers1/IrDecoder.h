...
class IrDecoder : public pulseIn<Timerx,Channel,Tick_1us,0xffff,TimerPol_Rising,34,0> 
{
  typedef pulseIn<Timerx,Channel,Tick_1us,0xffff,TimerPol_Rising,34,0> PulseIn;
