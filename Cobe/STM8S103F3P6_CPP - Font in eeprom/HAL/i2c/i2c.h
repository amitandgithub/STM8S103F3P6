...
namespace HAL
{
  ...
  namespace i2c
  {
    ...
    template <typename i2c_Master>
    class Master
    {
    public:
      static Status_t HwInit(void)
      {
        return i2c_Master::HwInit();
      }

      static void Start(uint8_t SlaveAddress)
      {
        i2c_Master::Start(SlaveAddress);
      }
