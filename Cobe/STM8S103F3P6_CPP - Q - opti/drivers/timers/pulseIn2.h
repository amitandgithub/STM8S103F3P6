...
protected:
  ...
  // Make this variable volatile as it is shared between ISR and main loop
...
public:
  ...
  {    
    ...
    if(Q.Write(capture2.Word - capture1.Word) == queue_t::QUEUE_FULL)
    {
      Stop();
    }
  }
